...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "Buffermaker API bindings for Scala.js",
    version := apiVersion,
    ...
    libraryDependencies ++= Seq(
        ...
        "io.scalajs.npm" %%% "bignum" % "0.12.5-2"
  ))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/buffermaker.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/buffermaker.git</developerConnection>
        <url>github.com/scalajs-io/buffermaker.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
